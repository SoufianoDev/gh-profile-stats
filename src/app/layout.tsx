...
export const metadata: Metadata = {
  ...
  description:
    "Generate beautiful, dynamically generated GitHub stats cards for your profile README. 13 stats, 15 themes, fully customizable SVG cards — just paste one line. No tokens, no setup, no deployment needed. Free and open source.",
  keywords: [
    "github stats",
