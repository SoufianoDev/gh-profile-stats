...
const PARAMS = [
  ...
  },
  {
    ...
    type: "string",
    default: '"bar"',
    desc: 'Language chart layout — "bar", "stacked", "horizontal_list", "vertical_list", or "grid"',
  },
  {
    name: "style",
    type: "string",
    ...
    <main className="min-h-screen">
      ...
      <header className="border-b border-[#21262d] bg-[#010409]">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <a
            href="https://github.com/SoufianoDev/gh-profile-stats"
            target="_blank"
      ...
      <section id="try" className="border-b border-[#21262d]">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <div className="flex flex-col sm:flex-row sm:items-end gap-4 mb-4">
            <div>
              <h2 className="text-2xl font-bold mb-1">Try It Out</h2>
      ...
      <section id="params" className="border-b border-[#21262d]">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          {/* Badge Styles */}
          <h3 className="text-xl font-semibold mt-10 mb-4">Badge Styles</h3>
          <p className="text-[#8b949e] mb-4">
            ...
            to switch look. Try the picker inside the editor above.
          </p>
          <pre className="overflow-x-auto rounded-lg border border-[#30363d] bg-[#161b22] px-5 py-3 text-sm text-[#c9d1d9] mb-4">
            ?style=for-the-badge
          </pre>
